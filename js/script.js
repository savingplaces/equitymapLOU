...
/////////////////Add Population Census Tract Data//////////////////////////
        ...
        var popTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/aachaf_louisville_tract10_select/FeatureServer",
          maxScale: 0,
          minScale: 0,   
          renderer: popTractRenderer,
          definitionExpression: "oldcity_yn = '1'",    
          opacity: .4,
          title: "{name_e}",    
          //outFields: ["*"],
          //title: " ",    
...
/**************************Add Non-Study Census Tracts******************************/
        ...
        var nonStudyTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LOU_NonStudy_Tracts/FeatureServer",
          maxScale: 0,
          minScale: 0,
          opacity: 1,
          renderer: {  
...
/**************************Add HAAN Tracts******************************/
        ...
        var Haan = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_HAAN/FeatureServer",
          maxScale: 0,
          minScale: 0,
          visible: true,     
          legendEnabled: true,    
...
/**************************Add HTC Project Points******************************/
        ...
        var htcProj = new FeatureLayer ({
            ...
            definitionExpression: "city = 'Louisville' AND state = 'KY' AND waso <> 24395 AND part3 >= '2009-01-01 00:00:00' AND part3 <= '2016-12-31 00:00:00'",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            popupEnabled: true, 
...
/**************************Add Local HDs******************************/
        ...
        var localHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Local_Historic_Districts/FeatureServer",
          definitionExpression: "PRESDIST_N NOT IN ('CITY OF ANCHORAGE', 'CITY OF MIDDLETOWN')",    
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add NRHP Sites******************************/
        ...
        var nrhpSites = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Lou_NRHP_Sites/FeatureServer",
...
/**************************Add NRHP HDs******************************/
        ...
        var nrhpHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_National_Register_Districts/FeatureServer",
          definitionExpression: "HISTDIST_N NOT IN ('RIVERSIDE FARNSLEY-MOREMEN LAN', 'TYLER SETTLEMENT', 'ANCHORAGE', 'ALTAWOOD', 'COUNTRY ESTATES OF RIVER ROAD')",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add Public Transportation Stations Layer******************************/
        ...
        const ctaRenderer = {
          ...
          uniqueValueInfos: [{
            ...
            value: "Circulator",
            symbol: groupCirculator,
            label: "Circulator"
          }, {
            value: "Limited Local",
            symbol: groupLimitedLocal,
            label: "Limited Local Route"
          }],
        };
    
        
        var ctaLines = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Transit/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,
          popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid'><td align='center' style='padding:2px'><h3>TARC Transit Line</h3></td></tr></tbody></table>"+"<table style='border:2px solid #b8b8b8; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='left' colspan='2' style='background-color: #d8cebc ;padding:5px'><h4>{ROUTE_NAME}</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Route Number</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{ROUTE_NUMBER}</h6></td></tr></tbody></table><br>"
            },    
          popupEnabled: true,    
          visible: false,
        ...
        var collUniv = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Universities_and_Colleges/FeatureServer",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            legendEnabled: true,
       ...
       const demoRenderThree = {
        ...
        var demoPermits = new FeatureLayer ({
           url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Demo_Permits/FeatureServer",
           ...
           popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid;'><td align='center' style='padding:2px'><h3>Demolition Permit</h3></td></tr></tbody></table>"+"<table style='border:2px solid #d1d1d1; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='center' colspan='2' style='background-color: #d8cebc ;padding:5px'><b><h4>Permit Information</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Type</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{PERMITTYPE}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Issue Date</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{ISSUEDATE}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Address</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{ADDRESS}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Category</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{CATEGORYNA}</h6></td></tr></tbody></table><br>"
                }
        });
...
/****************************Red Line Data*************************/
        ...
        var redLine = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Redlines_Boundaries/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
...
/**************************Add Neighborhood Boundaries******************************/
        ...
        var allNeighbor = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Neighborhoods/FeatureServer",
          definitionExpression: "NH_NAME <> 'REMAINDER OF CITY'",    
          maxScale: 0,
          minScale: 0,
          opacity: 1,    
          legendEnabled: true,
        ...
        var zoningBounds = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Lou_Old_City_Zoning_FAR/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.7,    
          legendEnabled: true,
        ...
        var cityLimits = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Louisville_Boundary/FeatureServer",
          legendEnabled: false,
          visible: true,
          maxScale: 0,
          minScale: 0,
        ...
        map.addMany([cartoBasemap, nonStudyTracts, popTracts, housingTracts, incomeTracts, zoningBounds, nrhpHd, localHd, Haan, allNeighbor, redLine, ctaLinesBack, ctaLines, collUniv, cityLimits, demoPermits, nrhpSites, htcProj]);  
...
/***********************Search Widgets************************/
        ...
        var neighborSearch = new Search({
                ...
                sources: [
                    {
                        layer: allNeighbor,
                        searchFields: ["NH_NAME"],
                        displayField: "NH_NAME",
                        exactMatch: false,
                        placeholder: "Enter a Neighborhood Name",
                        name: "Louisville Neighborhoods"
                    }
                  ],
        ...
        var localHdSearch = new Search({
                ...
                sources: [
                    {
                        layer: localHd,
                        searchFields: ["PRESDIST_N"],
                        displayField: "PRESDIST_N",
                        exactMatch: false,
        ...
        var nrhpHdSearch = new Search({
                ...
                sources: [
                    {
                        layer: nrhpHd,
                        searchFields: ["HISTDIST_N"],
                        displayField: "HISTDIST_N",
                        exactMatch: false,
                        placeholder: "Enter a District Name",
